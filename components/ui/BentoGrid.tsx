...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("ladogelashvili16@gmail.com");
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-3 w-fit absolute -right-3 lg:-right-2">
              ...
              <div className="flex flex-col gap-2 lg:gap-3">
                <span className="lg:py-3 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#10132E]" />
                {["Javascript", "Tailwind", "AWS"].map((item) => (
                  <span
                    key={item}
                    className="py-2 px-3 lg:py-3 lg:px-4 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]"
                  >
                    {item}
                  </span>
                ))}
